...
namespace U3DExtends
{
    public static class UIEditorHelper
    {
        ...
        static public GameObject GetUITestRootNode()
        {
            ...
            //}
            int objIndex = -1;
            object[] objects = Object.FindObjectsByType<GameObject>(FindObjectsSortMode.None);
        ...
        static public Transform GetContainerUnderMouse(Vector3 mouse_abs_pos, GameObject ignore_obj = null)
        {
            ...
            Canvas[] containers = Object.FindObjectsByType<Canvas>(FindObjectsSortMode.None);
        ...
        public static GameObject CreatNewLayout(bool isNeedLayout = true)
        {
            ...
            GameObject layout = Object.Instantiate(layout_prefab) as GameObject;
        ...
        public static Decorate CreateEmptyDecorate(Transform parent)
        {
            ...
            GameObject decorate = Object.Instantiate(decorate_prefab) as GameObject;
            ...
            if (layoutInfo != null && layoutInfo.LayoutPath != string.Empty)
            {
                ...
                if (is_reopen)
                {
                    ...
                    if (real_layout)
                    {
                        ...
                        PrefabUtility.UnpackPrefabInstance(new_view, PrefabUnpackMode.Completely, InteractionMode.AutomatedAction);
        ...
        public static void SaveAnotherLayout(Canvas layout, Transform child)
        {
            ...
            GameObject child_obj = child.gameObject;
            //判断选择的物体，是否为预设  
            PrefabAssetType prefabAssetType = PrefabUtility.GetPrefabAssetType(child_obj);
            PrefabInstanceStatus prefabInstanceStatus = PrefabUtility.GetPrefabInstanceStatus(child_obj);
            if (prefabAssetType != PrefabAssetType.NotAPrefab && prefabInstanceStatus != PrefabInstanceStatus.NotAPrefab)
            {
                ...
                Object new_prefab = PrefabUtility.SaveAsPrefabAsset(child_obj, save_path);
        ...
        public static void SaveLayout(GameObject o, bool isQuiet)
        {
            ...
            if (real_layout != null)
            {
                ...
                else
                {
                    ...
                    PrefabUtility.SaveAsPrefabAsset(child_obj, AssetDatabase.GetAssetPath(parentObject));
                    //刷新  
                    AssetDatabase.Refresh();
