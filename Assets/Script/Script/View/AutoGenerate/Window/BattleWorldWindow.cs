...
namespace ZM.UI
{
	public class BattleWorldWindow : WindowBase
	{

		public BattleWorldWindowDataComponent dataCompt;

		#region 生命周期函数
		//调用机制与Mono Awake一�??
		public override void OnAwake()
		{
			dataCompt = gameObject.GetComponent<BattleWorldWindowDataComponent>();
		...
		{
			HideWindow();
			UIModule.Instance.HideWindow("BarrierInfoWindow");
		}
		#endregion
	}
}
