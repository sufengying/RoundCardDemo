        ...
        public override void OnInspectorGUI () {
            ...
            if (expandHighlightOptions) {
                ...
                if (!ignore.boolValue) {
                    ...
                    if (usesHQEffects) {
                        ...
                        if (currentTarget == BuildTargetGroup.iOS || currentTarget == BuildTargetGroup.Android) {
            ...
            if (isMeshObject) {
                ...
                if (seeThrough.intValue != (int)SeeThroughMode.Never) {
                    ...
                    EditorGUILayout.PropertyField(seeThroughDepthOffset, new GUIContent("Depth Offset" + ((seeThroughDepthOffset.floatValue > 0) ? " â€?" : "")));
                    EditorGUILayout.PropertyField(seeThroughMaxDepth, new GUIContent("Max Depth" + ((seeThroughMaxDepth.floatValue > 0) ? " â€?" : "")));
                    ...
                    EditorGUILayout.PropertyField(seeThroughBorder, new GUIContent("Border When Hidden" + ((seeThroughBorder.floatValue > 0) ? " â€?" : "")));
